    ...
    <div className="home-container">
      ...
      <section className="hero-section d-flex align-items-center">
        <div className="container text-center">
          ...
          <p className="lead text-white-50">Services and Projects</p>
          <Link to="/projects" className="btn btn-primary btn-lg mx-2">View Projects</Link>
          <Link to="/skills" className="btn btn-outline-light btn-lg mx-2">Services</Link>
        </div>

         {/* Right side for additional background */}
